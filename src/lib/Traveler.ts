...
export class Traveler {
      ...
      public static activeStructureMatrixCache: {[roomName: string]: CostMatrix} | undefined = {};
      public  static creepMatrixCache: {[roomName: string]: CostMatrix} | undefined = {};
      ...
      private static structureMatrixCache: {[roomName: string]: number[]} = {};
